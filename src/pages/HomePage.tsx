...
export function HomePage() {
  ...
  // Optimization: Memoize filtering to prevent O(N) calculations and new Date() instantiation on every render
  ...
  // Optimization: Memoize this derived calculation to avoid O(N) loop on every render
