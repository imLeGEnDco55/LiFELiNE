  ...
  const deadlines: Deadline[] = [
    {
      ...
      deadline_at: addHours(now, 6).toISOString(), // Urgent - 6 hours
      priority: 'high',
      category_id: 'design',
    ...
    },
    {
      ...
      deadline_at: addDays(now, 2).toISOString(), // 2 days
      priority: 'high',
    ...
    },
    {
      ...
      deadline_at: addDays(now, 3).toISOString(), // 3 days
      priority: 'medium',
    ...
    },
    {
      ...
      deadline_at: addDays(now, 5).toISOString(), // 5 days
      priority: 'low',
    ...
    },
    {
      ...
      deadline_at: addDays(now, 7).toISOString(), // 7 days
      priority: 'high',
      category_id: 'work',
    ...
    },
    {
      ...
      deadline_at: addDays(now, 4).toISOString(), // 4 days
      priority: 'medium',
      category_id: 'design',
