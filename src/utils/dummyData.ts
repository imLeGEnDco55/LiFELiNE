...
export function generateDummyData() {
  ...
  const deadlines: Deadline[] = [
    ...
    // Children of demo-1 (Landing page)
    {
      id: 'demo-1-child-1',
      user_id: MOCK_USER_ID,
      title: 'Wireframes completos',
      description: 'Mobile y desktop wireframes',
      deadline_at: addDays(now, 1).toISOString(),
      priority: 'high',
      category_id: 'design',
      parent_id: 'demo-1',
      created_at: subHours(now, 36).toISOString(),
    ...
    },
    {
      id: 'demo-1-child-2',
      user_id: MOCK_USER_ID,
      title: 'Diseño visual final',
      description: 'Hero, features y footer',
      deadline_at: addDays(now, 2).toISOString(),
      priority: 'medium',
      category_id: 'design',
      parent_id: 'demo-1',
      created_at: subHours(now, 24).toISOString(),
      updated_at: subHours(now, 6).toISOString(),
      completed_at: null,
    },
    {
      id: 'demo-2',
    ...
    // Children of demo-2 (OAuth)
    {
      id: 'demo-2-child-1',
      user_id: MOCK_USER_ID,
      title: 'Configurar providers',
      description: 'Google Cloud y GitHub OAuth App',
      deadline_at: addDays(now, 2).toISOString(),
      priority: 'high',
      category_id: 'programming',
      parent_id: 'demo-2',
      created_at: subHours(now, 60).toISOString(),
      updated_at: subHours(now, 8).toISOString(),
      completed_at: null,
    },
    {
      id: 'demo-2-child-2',
      user_id: MOCK_USER_ID,
      title: 'Implementar flujo de login',
      description: 'Frontend y backend integration',
      deadline_at: addDays(now, 3).toISOString(),
      priority: 'medium',
      category_id: 'programming',
      parent_id: 'demo-2',
      created_at: subHours(now, 48).toISOString(),
      updated_at: subHours(now, 4).toISOString(),
      completed_at: null,
    },
    {
      id: 'demo-2-child-3',
      user_id: MOCK_USER_ID,
      title: 'Testing E2E',
      description: 'Pruebas completas del flujo',
      deadline_at: addDays(now, 4).toISOString(),
      priority: 'low',
      category_id: 'programming',
      parent_id: 'demo-2',
